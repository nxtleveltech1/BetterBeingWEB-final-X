...
export const products: Product[] = [
  {
    ...
    additionalImages: ["/products/go_go_pain_–_intense_pain_reliever_2.webp", "/products/go_go_pain_–_intense_pain_reliever_3.webp", "/products/go_go_pain_–_intense_pain_reliever_4.webp", "/products/go_go_pain_–_intense_pain_reliever_5.webp", "/products/go_go_pain_–_intense_pain_reliever_6.webp", "/products/go_go_pain_–_intense_pain_reliever_7.webp", "/products/go_go_pain_–_intense_pain_reliever_8.webp"],
    popular: false,
    featured: true,
    inStock: true,
    stockCount: 67,
    ...
    usage: "Take 1 capsule daily on an empty stomach, preferably in the morning.",
    categoryId: "natural-skincare",
    subcategoryId: "skincare",
