      ...
      <div className="border-b border-primary-foreground/20">
        <div className="container mx-auto px-4 py-16">
          <div className="text-center max-w-2xl mx-auto">
            <h3 className="text-3xl font-bold mb-4">Join the Wellness Revolution</h3>
        ...
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <div>
                <h3 className="text-xl font-bold">Better Being</h3>
          ...
          {/* Services & Support */}
          <div>
            <h4 className="text-lg font-semibold mb-6">Services & Support</h4>
            <ul className="space-y-3">
              ...
              <li><a href="/marketing" className="text-primary-foreground/80 hover:text-accent transition-colors">Marketing Partners</a></li>
              <li><a href="/tech" className="text-primary-foreground/80 hover:text-accent transition-colors">Technology</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-primary-foreground/80">info@better-being.co.za</span>
              </div>
